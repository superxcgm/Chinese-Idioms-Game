...
public class GBC extends GridBagConstraints{
     ...
     * @param gridy the dridy position
     */
    ...
    /**
     * Constructs a GBC with a given gridx, gridy, gridwidth, gridheight and all other grid bag
     * constraint values set to the default.
     * @param gridx the gridx position
     * @param gridy the dridy position
